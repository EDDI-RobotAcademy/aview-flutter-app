...
import 'kakao_terms_and_conditions_full.dart'; // ✅ 전체 약관 페이지 import

Future<bool> kakaoTermsAndConditions(BuildContext context) async {
  bool isAgreed = false;
                  ...
                  Align(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => KakaoTermsAndConditionsFull()), // ✅ 전체 약관 보기
                        );
                      },
